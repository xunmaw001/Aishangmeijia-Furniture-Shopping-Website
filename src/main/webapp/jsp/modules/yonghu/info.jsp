		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="pquestion" name="pquestion" class="form-control" v-model="ruleForm.pquestion" readonly>
				</div>
				<div class="form-item">
					<label>密保答案</label>

					<input id="panswer" name="panswer" class="form-control" v-model="ruleForm.panswer" readonly>
				</div>
