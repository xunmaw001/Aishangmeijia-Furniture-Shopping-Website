...
<body>
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>密保问题</label>
					<input name="pquestion" id="pquestion" name="pquestion" class="form-control" placeholder="请输入密保问题">
				</div>
				<div class="form-item">
					<label>密保答案</label>
					<input name="panswer" id="panswer" name="panswer" class="form-control" placeholder="请输入密保答案">
				</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#pquestion").val(ruleForm.pquestion);	
			$("#panswer").val(ruleForm.panswer);	
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.pquestion != null && res.data.pquestion != ''){

						$("#pquestion").val(res.data.pquestion);
						$("#pquestion").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.panswer != null && res.data.panswer != ''){

						$("#panswer").val(res.data.panswer);
						$("#panswer").attr('readonly','readonly');
					}
				}
			});  
            }
