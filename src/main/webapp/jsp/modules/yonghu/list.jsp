...
<body>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th>头像</th>
						<th>备注</th>
						<th onclick="sort('pquestion')">密保问题<i id="pquestionIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('panswer')">密保答案<i id="panswerIcon" class="fa fa-sort"></i></th>
						<th>操作</th>
					</tr>
				</thead>
				<tbody></tbody>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var pquestionCell  = document.createElement('td');

						 pquestionCell.innerHTML = item.pquestion;

			row.appendChild(pquestionCell);
			var panswerCell  = document.createElement('td');

						 panswerCell.innerHTML = item.panswer;

			row.appendChild(panswerCell);
