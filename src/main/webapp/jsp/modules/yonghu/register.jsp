...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<input  name="shenfenzheng"  placeholder="请输入身份证" class="form-control-i">
				</div>
				...
				<div class="list-item">
					<input  name="pquestion"  placeholder="请输入密保问题" class="form-control-i">
				</div>
				<div class="list-item">
					<input  name="panswer"  placeholder="请输入密保答案" class="form-control-i">
				</div>
