...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑家具分类</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>家具分类管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑家具分类</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>类型</label>
					<input name="leixing" id="leixing" name="leixing" class="form-control" placeholder="请输入类型">
				</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jiajufenlei/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("jiajufenlei/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("jiajufenlei/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jiajufenlei/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
