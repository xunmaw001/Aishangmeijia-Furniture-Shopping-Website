...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑轮播图管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑轮播图管理</span></li>
			</ol>
		</div>
			...
			<form id="addOrUpdateForm">
				...
				<div class="form-item-img">
                    ...
                    <div style="display: flex;align-items: center;">
                        <div v-for="(item,index) in valueImgList" :key="index" style="position: relative;">
                            <div style="position: absolute;right: 10px;top: 0;width: 32px;height: 32px;background: #fff;padding: 6px;font-size: 0;cursor: pointer;border-radius: 0 20px 0 0;" @click="valueDelClick(index)">
					...
					<div class="upload btn-img">选择文件<input name="file" type="file" id="valueupload" class="form-control-file"></div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			...
			methods: { 
                valueDelClick(index){
                    ...
                    if (mymessage == true) {
                        this.valueImgList.splice(index,1)  
                    }
		...
		function upload(){
			$('#valueupload').fileupload({
				...
				dataType: 'json',
                    ...
                    vm.valueImgList.push("upload/"+data.result.file)
				}
			});
		}  
		//取消 
		...
		function submit() {
			...
			if(validform() ==true && compare() == true){
                ...
                if(vm.valueImgList.length){
                    data.value = vm.valueImgList.join(',')
                }
		...
		function dataBind(){
            ...
            if(ruleForm.value){
                vm.valueImgList = ruleForm.value.split(',')
            }
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.value != null && res.data.value != ''){
                        ...
                        vm.valueImgList = res.data.value.split(',')
					}
				}
			});  
            }
