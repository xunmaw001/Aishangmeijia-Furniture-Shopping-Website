...
<html>
	...
	<body>
	<div id="apps">
		<div id="header" :style='{"padding":"0px","margin":"0 auto","alignItems":"center","display":"flex","right":"0","justifyContent":"space-between","overflow":"hidden","top":"0","left":"0","background":"url(http://codegen.caihongy.cn/20230106/a539c2eae5fc494c8c437927bc4dec2c.jpg) no-repeat center top","width":"100%","position":"relative","height":"64px","zIndex":"1002"}'>
			...
			<div v-if="projectName" :style='{"margin":"0 0 0 180px","color":"#fff","textAlign":"center","background":"none","width":"calc(100% - 360px)","lineHeight":"64px","fontSize":"22px","height":"64px"}' class="nav-top-title">{{projectName}}</div>
			<div :style='{"width":"180px","margin":"0","alignItems":"center","display":"flex"}'>
				<div :style='{"color":"#666","fontSize":"14px","display":"inline-block"}'></div>
				<button v-if="!Token" :style='{"border":"1px solid #b0def4","cursor":"pointer","padding":"0 20px","margin":"0 0 0 10px","color":"#333","borderRadius":"2px","background":"#c6eafc","display":"inline-block","fontSize":"14px","lineHeight":"32px","height":"32px"}' @click="jumpLogin('./pages/login/login.jsp')">登录/注册</button>
				<button v-if="Token" :style='{"border":"1px solid #eee","cursor":"pointer","padding":"0 20px","margin":"0 0 0 10px","color":"#666","borderRadius":"2px","background":"#fff","display":"inline-block","fontSize":"14px","lineHeight":"32px","height":"32px"}' @click="logout()">退出</button>
			</div>
		</div>
		
		
		<!-- 横向 -->
		<div id="navs" class="horizontal" :style='{"width":"100%","padding":"0","margin":"0px auto","textAlign":"center","background":"none","height":"auto"}'>
			<ul class="layui-nav" lay-bar="disabled" :style='{"border":"0","padding":"0","listStyle":"none","margin":"0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230107/1e2d9a53edad4e808d7a32aa63f52d04.jpg) no-repeat center top","position":"relative"}'>
		...
		<div id="tabbar" class="tabbar" :style='{"padding":"50px 50px 0","margin":"0 auto","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230106/fcc83ea04fae4a0e9b51402430234441.png) no-repeat center top / 100% auto,#f1f1f3","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"320px"}'>
