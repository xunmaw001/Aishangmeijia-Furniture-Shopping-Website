				...
				<div :style='{"padding":"10px 0 0px 0px","boxShadow":"0px 0px 0px #eee","borderColor":"#e6e6e6","overflow":"hidden","borderRadius":"4px","flexWrap":"wrap","background":"rgba(255,255,255,.6)","borderWidth":"1px","display":"flex","position":"relative","borderStyle":"solid","justifyContent":"space-between"}'>
					...
					<div :style='{"minHeight":"500px","padding":"20px 20px 20px","margin":"0px 0px 0 0px","borderColor":"#e6e6e6","background":"rgba(255,255,255,.0)","borderWidth":"0px","flex":"1","width":"48%","borderStyle":"solid","order":"4"}'>
						...
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>账号：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.zhanghao}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>姓名：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.xingming}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>性别：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.xingbie}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>手机：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.shouji}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>邮箱：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.youxiang}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>身份证：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.shenfenzheng}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>备注：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.beizhu}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>密保问题：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.pquestion}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>密保答案：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.panswer}}
							</div>
						</div>
