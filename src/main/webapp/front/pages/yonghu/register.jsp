		...
		<div id="register" class="register" :style='{"minHeight":"100vh","padding":"10px 0 80px","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230106/58eb0ca95fe94ea3912632230dc4f6d4.jpg) no-repeat center top /  100% 100%,#fff","display":"flex","width":"100%","justifyContent":"center"}'>
			<form id="registerForm" class="layui-form login-form" :style='{"padding":"10px 80px 20px  80px","boxShadow":"0 0px 0px rgba(0, 0, 0, .1)","margin":"0 auto","borderColor":"#98c6e2 #5fa6d0 #98c6e2 #5fa6d0","display":"flex","justifyContent":"flex-start","outline":"1px solid #eee","borderRadius":"0px","outlineOffset":"0px","flexWrap":"wrap","background":"#fff","borderWidth":"8px 16px 8px 16px","width":"800px","position":"relative","borderStyle":"solid","height":"auto"}' lay-filter="myForm">
				...
				<div :style='{"width":"100%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="form-item">
					...
					<input :style='{"padding":"0 10px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","outline":"none","borderColor":"#98c6e2","color":"#333","borderRadius":"4px","borderWidth":"2px","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text"   id="shouji" name="shouji" placeholder="请输入手机" autocomplete="off" class="layui-input">
				</div>
				<div :style='{"width":"100%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="form-item">
				...
				<div :style='{"width":"100%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="form-item">
					...
					<input :style='{"padding":"0 10px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","outline":"none","borderColor":"#98c6e2","color":"#333","borderRadius":"4px","borderWidth":"2px","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text"   id="shenfenzheng" name="shenfenzheng" placeholder="请输入身份证" autocomplete="off" class="layui-input">
				</div>
				<div :style='{"width":"100%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="form-item">
				...
				<div :style='{"width":"100%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="form-item">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>密保问题：</div>
					<input :style='{"padding":"0 10px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","outline":"none","borderColor":"#98c6e2","color":"#333","borderRadius":"4px","borderWidth":"2px","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text"   id="pquestion" name="pquestion" placeholder="请输入密保问题" autocomplete="off" class="layui-input">
				</div>
				<div :style='{"width":"100%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="form-item">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>密保答案：</div>
					<input :style='{"padding":"0 10px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","outline":"none","borderColor":"#98c6e2","color":"#333","borderRadius":"4px","borderWidth":"2px","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text"   id="panswer" name="panswer" placeholder="请输入密保答案" autocomplete="off" class="layui-input">
				</div>
