			...
			<div class="data-detail" :style='{"width":"90%","margin":"10px auto","position":"relative","background":"none"}'>
				<div :style='{"padding":"10px 0 0px 0px","boxShadow":"0px 0px 0px #eee","borderColor":"#e6e6e6","overflow":"hidden","borderRadius":"4px","flexWrap":"wrap","background":"rgba(255,255,255,.6)","borderWidth":"1px","display":"flex","position":"relative","borderStyle":"solid","justifyContent":"space-between"}'>
					...
					<div :style='{"minHeight":"500px","padding":"20px 20px 20px","margin":"0px 0px 0 0px","borderColor":"#e6e6e6","background":"rgba(255,255,255,.0)","borderWidth":"0px","flex":"1","width":"48%","borderStyle":"solid","order":"4"}'>
						...
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' v-if="detail.price" class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>价格：</div>
							<div :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}'>￥{{Number(detail.price).toFixed(2)}}</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' v-if="detail.jf" class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>积分：</div>
							<div :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}'>
								{{detail.jf}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' v-if="detail.onelimittimes" class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>单次购买：</div>
						...
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' v-if="detail.alllimittimes" class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>库存：</div>
							<div :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
						...
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>家具编号：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.jiajubianhao}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>家具类型：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.jiajuleixing}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>生产日期：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.shengchanriqi}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>适用场合：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.shiyongchanghe}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 0 10px 0","borderColor":"#f5d4d4","background":"none","borderWidth":"0px 0px 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px","color":"#2693b3","textAlign":"right","background":"none","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"120px","height":"40px"}'>家具材质：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"none"}' class="desc">
								{{detail.jiajucaizhi}}
							</div>
						</div>
						...
						<div class="detail-item" :style='{"padding":"10px 0","flexWrap":"wrap","background":"none","display":"flex"}'>
							...
							<div :style='{"margin":"0 5px 0 0","display":"flex"}' class="num-picker" >
								<button :style='{"border":"1px solid #eee","padding":"0","boxShadow":"inset 0px 0px 0px 0px #dcedf8","color":"#999","background":"none","width":"40px","lineHeight":"32px","fontSize":"24px","height":"36px"}' type="button" @click="buynumber>0?buynumber--:buynumber" class="layui-btn layui-btn-primary">-</button>
								<input :style='{"padding":"0 10px","borderColor":"#eee","margin":"0 0px","borderRadius":"0","color":"#999","textAlign":"center","borderWidth":"1px 0px","background":"none","width":"80px","lineHeight":"32px","borderStyle":"solid","height":"36px"}' type="number" v-model="buynumber" id="buynumber" name="buynumber" class="layui-input" disabled="disabled"></input>
								<button :style='{"border":"1px solid #eee","padding":"0","boxShadow":"inset 0px 0px 0px 0px #dcedf8","color":"#999","background":"none","width":"40px","lineHeight":"32px","fontSize":"24px","height":"36px"}' type="button" @click="buynumber++" class="layui-btn layui-btn-primary">+</button>
							</div>
							<button  :style='{"border":"0px solid #b8d7f2","cursor":"pointer","padding":"0 10px","margin":"0 5px 0px 0","outline":"none","color":"#333","borderRadius":"4px","background":"#c5ddfb","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' @click="addCartTap" type="button" class="layui-btn layui-btn-warm">
								添加到购物车
							</button>
							<button  :style='{"border":"0px solid #b5f0f0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0px 0","outline":"none","color":"#333","borderRadius":"4px","background":"#b9f4e3","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' @click="buyTap" type="button" class="layui-btn btn-submit">
								立即购买
							</button>
					...
					<div v-if="true" class="hot" :style='{"padding":"20px 20px 0","margin":"0px auto 0","background":"#fff","width":"calc(51% - 0px)","position":"relative","height":"auto","order":"2"}'>
					  ...
					  <div :style='{"padding":"10px 10px 0","margin":"10px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
					    <div v-for="item in hotList" :key="item" :style='{"border":"1px solid #e6e6e6","padding":"10px","margin":"0 0 20px","borderRadius":"4px","background":"#fff","width":"48%","height":"auto"}' @click="jump('../jiajushangpin/detail.jsp?id='+item.id)">
					      <img :style='{"cursor":"pointer","padding":"0px","borderColor":"#c7eec2","objectFit":"cover","borderRadius":"8px","borderWidth":"0px","background":"#fff","display":"block","width":"100%","borderStyle":"solid","height":"150px"}' :src="item.tupian?(baseurl+item.tupian.split(',')[0]):''" alt="">
					      <div :style='{"cursor":"pointer","padding":"4px 5px 4px","borderColor":"#eee","color":"#3d74c0","background":"none","borderWidth":"0 0 0px","lineHeight":"24px","fontSize":"14px","borderStyle":"solid"}'>{{item.jiajumingcheng}}</div>
					      <div :style='{"cursor":"pointer","padding":"4px 5px 4px","borderColor":"#eee","color":"#3d74c0","background":"none","borderWidth":"0 0 0px","lineHeight":"24px","fontSize":"14px","borderStyle":"solid"}'>{{item.jiajuleixing}}</div>
					      <div :style='{"cursor":"pointer","padding":"4px 5px 4px","borderColor":"#eee","color":"#3d74c0","background":"none","borderWidth":"0 0 0px","lineHeight":"24px","fontSize":"14px","borderStyle":"solid"}'>{{item.shiyongchanghe}}</div>
					      <div :style='{"cursor":"pointer","padding":"4px 5px 4px","borderColor":"#eee","color":"#3d74c0","background":"none","borderWidth":"0 0 0px","lineHeight":"24px","fontSize":"14px","borderStyle":"solid"}'>{{item.jiajucaizhi}}</div>
				...
				<div class="layui-tab layui-tab-card" :style='{"boxShadow":"0 0px 0px rgb(0 0 0 / 30%)","padding":"10px","margin":"20px 0 0","borderColor":"#e6e6e6","overflow":"hidden","borderRadius":"4px","background":"rgba(255,255,255,1)","borderWidth":"1px","width":"100%","clear":"both","borderStyle":"solid","order":"10"}'>
					...
					<div :style='{"padding":"15px","background":"#fff"}' class="layui-tab-content">
						...
						<div class="layui-tab-item layui-show">
							<div v-html="detail.jiajuxiangqing"></div>
						</div>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable,statusColumnName,tips,statusColumnValue){
						localStorage.setItem('crossTable',`jiajushangpin`);
					...
					addCartTap() {
						...
						layui.http.request('cart/list', 'get', {
							...
							layui.http.requestJson('cart/save', 'post', {
								...
								goodid: this.detail.id,
								goodname: this.title,
                                goodtype: this.detail.jiajuleixing,
					...
					storeUp() {
						layui.http.request('storeup/list', 'get', {
							...
							layui.http.requestJson('storeup/save', 'post', {
							    ...
							    type:1,
								picture:vue.detail.tupian.split(",")[0],
                                inteltype: vue.detail.jiajuleixing,
								refid: this.detail.id,
								tablename: this.detailTable
							}, function(res) {
								layer.msg('收藏成功', {
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
					vue.title = vue.detail.jiajumingcheng;
					// 轮播图片
                ...
                function getHotList() {
                    var autoSortUrl = "jiajushangpin/autoSort";
                    if(localStorage.getItem('Token')) {
                        autoSortUrl = "jiajushangpin/autoSort2";
                    }
                    var param = {
                        page: 1,
                        limit: 4
